<template>
    ...
    <section class="bg-teal-200 w-full flex flex-col-reverse sm:flex-row p-4">
        <div class="w-full sm:w-1/2 my-12 m-4 max-sm:mx-0">
            <p class="m-4 max-sm:m-2 text-sm md:text-base font-mono font-light text-slate-700">
                Trending product in {{ monthYear }}
            </p>
            <h2 class="font-semibold mx-4 max-sm:mx-2 text-xl lg:text-4xl capitalize font-serif text-slate-900">
                Stylize and beautify your mobile devices whilst improving your productivity
            </h2>

            <p class="mx-4 max-sm:mx-2 my-5 text-sm text-slate-600 font-serif font-extralight">
            ...
            <button class="m-4 max-sm:m-2 bg-slate-700 text-white hover:bg-white group py-2 rounded-full transition duration-100">
    ...
    <section class="py-10">
        ...
        <div class="flex flex-wrap justify-evenly flex-row items-center">
            <ServicesCard
    ...
    <section :class="state.countdownPassed ? 'hidden' : ''">
        <div class="flex max-h-80 gap-2 w-full text-white p-12 max-sm:p-6 bg-purple-900 text-left">
            <div class="w-1/2">
                ...
                <router-link to="/products">
                    <button class="my-4 capitalize relative inline-flex items-center justify-center p-0.5 mb-2 mr-2 overflow-hidden text-sm font-medium text-purple-800 rounded-lg group focus:outline-none outline-none border border-purple-900">
