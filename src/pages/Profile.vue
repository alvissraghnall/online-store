<template>
    ...
    >
      <button
        ...
        class="p-2 border-2 bg-none z-[33] rounded-md shadow-lg text-gray-500 focus:outline-none fixed top-12 left-0 md:hidden transition-all duration-500 ease-in-out"
        :class="{ 'left-28 md:left-60': sidenav }"
      >
        <svg
      ...
      <div
        id="sidebar"
        class="bg-white h-screen md:block shadow-xl px-3 w-28 md:w-60 lg:w-60 overflow-x-hidden transition-transform ease-in-out duration-500 transform"
        x-show="sidenav"
        :class="{ '-translate-x-full': !sidenav, 'translate-x-0': sidenav }"
    ...
    nfksdk
    <div class="my-[34rem]">vbbgh fg</div>
